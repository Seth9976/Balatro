...
public class AlertDialogLayout extends y {
    ...
    protected void onLayout(boolean z, int v, int v1, int v2, int v3) {
        ...
        for(int v13 = 0; v13 < v9; ++v13) {
            ...
            if(view0 != null && view0.getVisibility() != 8) {
                ...
                a y$a0 = (a)view0.getLayoutParams();
                switch(e.a((y$a0.gravity >= 0 ? y$a0.gravity : v10 & 0x800007), v.o(this)) & 7) {
                    case 1: {
                        v16 = (v5 - v4 - v7 - v14) / 2 + v4 + y$a0.leftMargin - y$a0.rightMargin;
                        break;
                    }
                    case 5: {
                        v16 = v5 - v6 - v14 - y$a0.rightMargin;
                        break;
                    }
                    default: {
                        v16 = y$a0.leftMargin + v4;
                    }
                }
                if(this.q(v13)) {
                    v11 += v12;
                }
                int v17 = v11 + y$a0.topMargin;
                this.x(view0, v16, v17, v14, v15);
                v11 = v17 + (v15 + y$a0.bottomMargin);
            }
        }
    }
    ...
    private static int y(View view0) {
        int v = v.p(view0);
        if(v > 0) {
            return v;
        }
        return !(view0 instanceof ViewGroup) || ((ViewGroup)view0).getChildCount() != 1 ? 0 : AlertDialogLayout.y(((ViewGroup)view0).getChildAt(0));
    }
