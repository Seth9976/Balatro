...
abstract class t2 {
    ...
    static String a(r2 r20, String s) {
        StringBuilder stringBuilder0 = new StringBuilder();
        stringBuilder0.append("# ");
        stringBuilder0.append(s);
        t2.d(r20, stringBuilder0, 0);
        return stringBuilder0.toString();
    }

    static void b(StringBuilder stringBuilder0, int v, String s, Object object0) {
        if(object0 instanceof List) {
            for(Object object1: ((List)object0)) {
                t2.b(stringBuilder0, v, s, object1);
            }
            return;
        }
        if(object0 instanceof Map) {
            for(Object object2: ((Map)object0).entrySet()) {
                t2.b(stringBuilder0, v, s, ((Map.Entry)object2));
            }
            return;
        }
        stringBuilder0.append('\n');
        t2.c(v, stringBuilder0);
        if(!s.isEmpty()) {
        ...
        if(object0 instanceof String) {
            stringBuilder0.append(": \"");
            stringBuilder0.append(q3.a(new n0(((String)object0).getBytes(v1.b))));
            stringBuilder0.append('\"');
            return;
        }
        if(object0 instanceof q0) {
            stringBuilder0.append(": \"");
            stringBuilder0.append(q3.a(((q0)object0)));
            stringBuilder0.append('\"');
            return;
        }
        if(object0 instanceof n1) {
            stringBuilder0.append(" {");
            t2.d(((n1)object0), stringBuilder0, v + 2);
            stringBuilder0.append("\n");
            t2.c(v, stringBuilder0);
            stringBuilder0.append("}");
            return;
        ...
        if(object0 instanceof Map.Entry) {
            stringBuilder0.append(" {");
            t2.b(stringBuilder0, v + 2, "key", ((Map.Entry)object0).getKey());
            t2.b(stringBuilder0, v + 2, "value", ((Map.Entry)object0).getValue());
            stringBuilder0.append("\n");
            t2.c(v, stringBuilder0);
            stringBuilder0.append("}");
            return;
    ...
    private static void c(int v, StringBuilder stringBuilder0) {
        while(true) {
            int v1 = 80;
            if(v <= 0) {
                break;
            ...
            stringBuilder0.append(t2.a, 0, v1);
            v -= v1;
        }
    }

    private static void d(r2 r20, StringBuilder stringBuilder0, int v) {
        String s1;
        HashSet hashSet0 = new HashSet();
        HashMap hashMap0 = new HashMap();
        TreeMap treeMap0 = new TreeMap();
        Method[] arr_method = r20.getClass().getDeclaredMethods();
        ...
        for(Object object0: treeMap0.entrySet()) {
            ...
            if(s.endsWith("List") && !s.endsWith("OrBuilderList") && !s.equals("List")) {
                ...
                if(method1 != null && method1.getReturnType().equals(List.class)) {
                    t2.b(stringBuilder0, v, s.substring(0, s.length() - 4), n1.q(method1, r20, new Object[0]));
                    continue;
                }
            }
            if(s.endsWith("Map") && !s.equals("Map")) {
                ...
                if(method2 != null && method2.getReturnType().equals(Map.class) && !method2.isAnnotationPresent(Deprecated.class) && Modifier.isPublic(method2.getModifiers())) {
                    t2.b(stringBuilder0, v, s.substring(0, s.length() - 3), n1.q(method2, r20, new Object[0]));
                    continue;
                }
            }
            if(hashSet0.contains("set" + s) && (!s.endsWith("Bytes") || !treeMap0.containsKey("get" + s.substring(0, s.length() - 5)))) {
                ...
                if(method3 != null) {
                    Object object1 = n1.q(method3, r20, new Object[0]);
                    if(method4 == null) {
                        if(object1 instanceof Boolean) {
                            ...
                            if(object1 instanceof q0) {
                                s1 = q0.f;
                            label_57:
                                if(object1.equals(s1)) {
                                    continue;
                                }
                            }
                            else if(object1 instanceof r2) {
                                if(object1 == ((r2)object1).g()) {
                                    continue;
                                }
                            }
                    ...
                    label_64:
                        if(((Boolean)n1.q(method4, r20, new Object[0])).booleanValue()) {
                            goto label_65;
                        }
                        continue;
                    }
