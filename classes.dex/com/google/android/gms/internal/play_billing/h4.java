...
abstract class h4 {
    ...
    static int b(String s, byte[] arr_b, int v, int v1) {
        int v2 = s.length();
        int v3;
        for(v3 = 0; true; ++v3) {
            int v4 = v + v1;
    ...
    static boolean d(byte[] arr_b) {
        return h4.a.b(arr_b, 0, arr_b.length);
    }

    static boolean e(byte[] arr_b, int v, int v1) {
        return h4.a.b(arr_b, v, v1);
    }
}
